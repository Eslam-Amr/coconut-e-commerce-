...
class AdminRequest extends MasterRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'email' => [$requireOrSometimes, 'email', 'unique:users,email|max:255'],
            'phone' => [$requireOrSometimes, 'string', 'unique:users,phone|max:20'],
            'password' => [$requireOrSometimes, 'string', 'min:8', 'confirmed'],
            'password_confirmation' => [$requireOrSometimes, 'string', 'min:8'],
            'locale' => [$requireOrSometimes, 'string', 'in:en,ar'],
